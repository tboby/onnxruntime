...
# python cmake/deps_update_and_upload.py --root-path C:/temp/onnxruntime_deps --version 1.0.126 --do-upload
...
parser.add_argument("--version", type=str, default="1.0.126", help="Package version to publish")
